...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `elm` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("elm",e)})();/*! `xml` grammar compiled for Highlight.js 11.7.0 */
...
}),n,{begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `csharp` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
...
}})();hljs.registerLanguage("php",e)})();/*! `wasm` grammar compiled for Highlight.js 11.7.0 */
