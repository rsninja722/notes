...
[logic applied to the world](?note=notes/concepts/humanities/logic_applied_to_the_world.md) <!-- [](/notes/concepts/humanities/logic_applied_to_the_world.md) -->

## arguments

[arguments](?note=notes/concepts/humanities/logic_arguments.md) <!-- [](/notes/concepts/humanities/logic_arguments.md) -->

## validity

[validity](?note=notes/concepts/humanities/logic_validity.md) <!-- [](/notes/concepts/humanities/logic_validity.md) -->

## statement logic

[statement logic](?note=notes/concepts/humanities/statement_logic.md) <!-- [](/notes/concepts/humanities/statement_logic.md) -->
