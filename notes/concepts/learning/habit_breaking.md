...
- Another problem of breaking habits is that you produce dopamine when you start the activity, but not as you keep doing it.


## method

- engage in the activity, but practice being aware the whole time, this leads to 2 things: 
    - you will notice when an activity stops being pleasurable, causing it to be less appealing
